<template>
  <div class="container">
    <div class="qu-wrap">
      <header>
        <router-link tag="span" to="/"><a-icon type="arrow-left" />返回</router-link>
      ...
      <div class="qu-content">
        <div class="qu-item" v-for="(item, index) in questionList" :key="index">
          <section class="qu-data">
            ...
            >
              <a-list-item  slot="renderItem" slot-scope="answer, index"><div style="display:block;width:100%;">{{answer.content}}</div><div style="width:160px;display:block;">{{answer.creattime}}</div></a-list-item>
            </a-list>
          </section>
